        ...
        <main className="px-[5%] py-20 grid grid-cols-1 md:grid-cols-2 items-center gap-6">
            <section className="grid grid-cols-1 gap-4">
                ...
                <div className="flex items-center gap-2 special-font">
                    <div>
                        <Image src="/img/choose.png" width={40} height={40} alt="img" />
                    </div>
                    <div>
                        <h2 className="text-[16px] text-litegrey font-bold">Choose Destination</h2>
                        <p className="text-[16px] text-litegrey font-normal max-w-[300px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus. </p>
                    </div>
                </div>

                <div className="flex items-center gap-2 special-font">
                    <div>
                        <Image src="/img/make.png" width={40} height={40} alt="img" />
                    </div>
                    <div>
                        <h2 className="text-[16px] text-litegrey font-bold">Make Payment</h2>
                        <p className="text-[16px] text-litegrey font-normal max-w-[300px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus. </p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 special-font">
                    <div>
                        <Image src="/img/reach.png" width={40} height={40} alt="img" />
                    </div>
                    <div>
                        <h2 className="text-[16px] text-litegrey font-bold">Reach Airport on Selected Date</h2>
                        <p className="text-[16px] text-litegrey font-normal max-w-[300px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Urna, tortor tempus. </p>
                    </div>
                </div>
            </section>
            ...
            <section className="relative mt-20 md-mt-0 special-font">
                <div className=" p-4 rounded-2xl shadow-md w-[90%] md:max-w-[70%] grid grid-cols-1 gap-4 relative z-10 bg-white">
                    ...
                    <div className="grid gap-2 relative bg-white w-full">
                        ...
                        <div className="p-4 rounded-2xl shadow-md max-w-[500px] absolute right-[-60px] bottom-6 bg-white">
